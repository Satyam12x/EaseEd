...
const About = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-500 to-purple-500 relative overflow-hidden">
      ...
      >
        <h2 className="text-4xl font-bold text-white mb-6">About EaseEd</h2>
        <p className="text-lg text-white/80 mb-4">
          EaseEd is an AI-powered learning platform designed to make education
          accessible and engaging. Our mission is to empower students and
          learners by transforming any content—text, PDFs, images, or YouTube
          videos—into clear explanations, concise notes, and interactive
          quizzes.
        </p>
        <p className="text-lg text-white/80">
          Built with cutting-edge AI (Gemini 2.5 Flash), EaseEd simplifies
          complex topics and supports diverse learning styles. Whether you're
          studying for exams or exploring new subjects, we’re here to make
